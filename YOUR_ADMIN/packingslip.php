...
<!-- SWEETFABRIK_GENERAL_FIX REPLACE BEGIN -->
          <tr>
            <td class="main"><b><?php echo ENTRY_TELEPHONE_NUMBER; ?></b><?php echo $order->customer['telephone']; ?></td>
          </tr>
          <tr>
            <td class="main"><b><?php echo ENTRY_EMAIL_ADDRESS; ?></b><?php echo '<a href="mailto:' . $order->customer['email_address'] . '">' . $order->customer['email_address'] . '</a>'; ?></td>
          </tr>
<!-- SWEETFABRIK_GENERAL_FIX REPLACE END -->
<!-- TVA_INTRACOM BEGIN -->
