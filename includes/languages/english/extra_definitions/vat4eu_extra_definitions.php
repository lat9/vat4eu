...
define('VAT4EU_VAT_NOT_VALIDATED', 'We were unable to validate the <em>VAT Number</em> that you entered.  Please <a href="' . zen_href_link(FILENAME_CONTACT_US, '', 'SSL') . '">contact us</a> for assistance.');
