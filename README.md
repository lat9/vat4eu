# Zen Cart&reg; VAT for EU Countries, v4.1.0
Now supporting Zen Cart 2.1.0 and above, released as a Zen Cart `encapsulated` plugin.  Validated on PHP versions 8.0 through 8.5.
